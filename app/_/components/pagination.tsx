...
function Pagination ({ pages }: { pages: PaginationType }) {
    ...
    return (
        <nav className="flex gap-x-1 w-full justify-center my-3">
            {pages.previous > 0 && (<>
                <Link href={{ query: { ...query, page: pages.previous } }} className="min-h-[1rem] min-w-[1rem] inline-flex justify-center items-center hover:opacity-50 mr-1.5" data-testid="previous">
            ...
            <form className="flex items-center gap-x-1" onSubmit={jumpPage}>
                ...
                <span className="min-h-[32px] flex justify-center items-center text-gray-500 py-1.5 px-1.5 text-sm dark:text-gray-500" data-testid="last">{pages.last}</span>
            </form>
            {pages.next > 0 && (<>
                <Link href={{ query: { ...query, page: pages.next } }} className="min-h-[1rem] min-w-[1rem] inline-flex justify-center items-center hover:opacity-50" data-testid="next">
