        ...
        <div className="w-full lg:max-w-sm mx-1 mb-2">
            <div className="h-full flex flex-col p-4 md:pb-9 bg-gradient-to-t from-white via-neutral-200/75 via-10% to-white to-50%">
                <div className="flex">
                    ...
                    <Link href={record.link} target="feed" className='w-full flex'><h1 className="self-center w-full pb-2.5 title-font font-medium text-gray-700 text-sm md:text-lg">{record.title}</h1></Link>
                </div>
